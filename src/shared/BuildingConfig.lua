...
BuildingConfig.Buildings = {
	...
	StoneHouse = { DisplayName = "Stone House", Description = "A sturdy dwelling made of stone.", Category = "Structures", FootprintX = 10, FootprintZ = 10, FootprintY = 9, Cost = { Log = 2, Stone = 5 }, MinAge = 16 },
	Longhouse = { DisplayName = "Longhouse", Description = "A large communal hall for feasts and gatherings.", Category = "Structures", FootprintX = 16, FootprintZ = 8, FootprintY = 8, Cost = { Log = 8 }, MinAge = 18 },
	...
	WatchTower = { DisplayName = "Watch Tower", Description = "A tall lookout tower.", Category = "Defenses", FootprintX = 6, FootprintZ = 6, FootprintY = 14, Cost = { Log = 4, Stone = 3 }, MinAge = 16 },
	...
	Forge = { DisplayName = "Forge", Description = "Smelt ores and craft metal tools and weapons.", Category = "Crafting", FootprintX = 6, FootprintZ = 5, FootprintY = 6, Cost = { Log = 3, Stone = 5 }, MinAge = 16 },
